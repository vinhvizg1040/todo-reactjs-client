    ...
    return (
        <>
            <div class="flex min-h-full items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
                <div class="w-full max-w-md space-y-10 p-8 bg-[#363636] rounded-xl shadow-md shadow-[#333333]">
                    ...
                    <form class="space-y-8">
                        <div class="space-y-3 rounded-md shadow-sm">
                            <div>
                                <input className='bg-[#363636] focus:outline-none text-[#FFFFFF] text-lg p-1 text-start w-full h-full rounded-xl border-white border-2' id="email-address" name="email" type="email" autocomplete="email" required placeholder="Email address" />
                            </div>
                            <div>
                                <input className='bg-[#363636] focus:outline-none text-[#FFFFFF] text-lg p-1 text-start w-full h-full rounded-xl border-white border-2' id="password" name="password" type="password" autocomplete="current-password" required placeholder="Password" />
                            </div>
                        </div>
